    ...
    def get_items( self , channel = {} ):
        ...
        for item in channel['rss']['channel']['item']:
            ...
            new_item = {
                ...
                "guid": item['guid'],
                "country": item.get( 'country' , channel['rss']['channel'].get('country') ),
                "region": item.get( 'region' , channel['rss']['channel'].get('region') ),
                "province": item.get( 'province' , channel['rss']['channel'].get('province') ),
                "municipality": item.get( 'municipality' , channel['rss']['channel'].get('municipality') ),
                "latitude": item.get( 'latitude' , channel['rss']['channel'].get('latitude') ),
